...
**功能描述**：上传 TXT/Markdown/PDF/Word 文件，自动分片、索引、支持混合检索

#### 3.2.1 文件管理
| 功能点 | 描述 | 优先级 |
|--------|------|--------|
| 文件上传 | 支持 .txt, .md, .pdf, .doc, .docx 文件 | P0 |
| 文件列表 | 展示已上传文件及状态 | P0 |
| 文件删除 | 删除已上传文件 | P1 |
| 文档数量统计 | 展示总文档数 | P1 |
...
| 处理阶段 | 描述 |
|----------|------|
| 文本提取 | 解析 TXT/Markdown/PDF/Word 内容 |
| 清洗 | 去除特殊字符、空白规范化 |
...
| 文件上传 | 上传 txt/md/pdf/doc/docx 文件，解析后出现在列表 |
| 知识检索 | 搜索关键词，返回相关文档片段 |
